...
public class PlaylistController {
    ...
    public Playlist viewPlaylist(@PathVariable String name,HttpSession session) {
    	String createdBy=session.getAttribute("email").toString();
        return playlistService.getPlaylistSongs(name,createdBy);
    }
